		...
		<table class="acymailing_table" cellpadding="1">
			...
			for($i = 0, $a = count($this->rows); $i < $a; $i++){
				...
				<tr class="<?php echo "row$k"; ?>" id="<?php echo $id; ?>">
					...
					<td align="center" style="text-align:center">
						<a href="<?php echo acymailing_completeLink('statsurl&task=detaillisting&filter_mail='.$row->mailid.'&filter_url='.$row->urlid, false) ?>" rel="{handler: 'iframe', size:{x:800, y:500}}">
							<?php echo $row->uniqueclick; ?>
						</a>
					</td>
					<td align="center" style="text-align:center">
						<?php echo $row->totalclick; ?>
					</td>
				</tr>
				<?php
				$k = 1 - $k;
