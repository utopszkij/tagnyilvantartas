...
class TagnyilvantartasModeloevks extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*');
		$query->from('#__tny_oevk_torzs as a');
		...
		if (!empty($search))
		{
			...
			else
			{
				...
				$query->where('((a.telepules LIKE ' . $search . ' ) or (a.oevk LIKE '.$search.'))');
			}
		}
		...
		if(empty($orderCol)) $orderCol = 'a.ev,a.oevk,a.telepules';
