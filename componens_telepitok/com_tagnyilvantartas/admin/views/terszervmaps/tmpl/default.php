...
<h2>Települések - ter.szervezetek</h2>
<form action="index.php?option=com_tagnyilvantartas&view=terszervmap" method="post" name="adminForm" id="adminForm">
...
<div id="editcell">
	<table style="width:600px" class="adminlist" id="articleList">
		<thead>
			<tr>
				...
				<tr class="row<?php echo $i % 2; ?>"">
        			<td><?php 
                        ...
                        echo '<input type="radio" id="cb'.$item->kapcs_id.'" name="cid[]"
                           onclick="cbClick(this)" value="'.$item->telepules.'|'.$item->kerulet.'"/>
                        ';
                        ?></td>
			        <td class="nowrap has-context">
						<?php  echo $this->escape($item->telepules); ?>
					</td>
			        <td class="nowrap has-context">
						<?php  echo $this->escape($item->kerulet); ?>
					</td>
			        <td class="nowrap has-context">
						<?php  echo $this->escape($item->terszerv_nev); ?>
					</td>
				</tr>
<?php
  endforeach;
...
<input type="hidden" name="task" value="terszervmap" />
<input type="hidden" name="view" value="terszervmaps" />
