...
class TagnyilvantartasViewfelhasznaloks  extends JViewLegacy {
	...
	public function display($tpl = null)
	{
		...
		TagnyilvantartasHelper::addSubmenu('felhasznaloks');
	...
	{
		return array(
		 	          'a.name' => JText::_('USER_NAME'),
		 	          'a.username' => JText::_('USER_USERNAME'),
		 	          'a.email' => JText::_('USER_EMAIL'),
	     	          'a.id' => JText::_('USER_ID')
	     		);
	}	
}
?>
