					...
					<div class="controls">	
						<?php 
						   ...
						   if ($this->form->getValue('telefon') != '')
						      echo '<a id="tsz'.$this->item->kapcs_id.'" onclick="telszamClick('.$this->item->kapcs_id.')" 
						               href="tel:'.$s1.'">'.$this->form->getValue('telefon').'</a><br />';  
						   if ($this->form->getValue('telefon2') != '')
						      echo '<a id="tsz'.$this->item->kapcs_id.'" onclick="telszamClick('.$this->item->kapcs_id.')" 
						               href="tel:'.$s2.'">'.$this->form->getValue('telefon2').'</a><br />';
						   echo '<span id="tm'.$this->item->kapcs_id.'">'.$this->form->getValue('telszammegj').'</span>';
						?>
					</div>
				</div>		
