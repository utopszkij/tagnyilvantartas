...
if (count($res) > 0) {
	$hirlevel_csatlakozasok = '<div class="hirlevel_csatlakozasok" style="text-align:left">
          ...
          <fieldset class="adminform bal">
                ...
                <div class="allandolakcim">
                    ...
                    <div class="control-group">
						...
						<div class="controls">	
							<?php echo $this->form->getInput('orszag');  ?>
						</div>
					</div>	
                    <div class="control-group">
                        <div class="control-label">					
                ...
                <div class="control-group">
					...
					<div class="controls">	
						<?php echo $this->form->getInput('torszag');  ?>
					</div>
				</div>	
				<div class="control-group">
					<div class="control-label">					
...
<?php echo $hirlevel_csatlakozasok; ?>
    ...
    <script type="text/javascript">
	   ...
	   function utcaHelpClick() {
		   ...
		   ifrm1.src = 'http://robitc/lmp/utcak.php?telepules='+tel.value+'&kerulet='+ker.value;
