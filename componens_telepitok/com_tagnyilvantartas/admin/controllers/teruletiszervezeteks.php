...
/**
 * Teruletiszervezetek list controller class.
 *
 * @package     Joomla.Administrator
 * @subpackage  Tagnyilvantartas
 */
class TagnyilvantartasControllerTeruletiszervezeteks extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	 ...
	 *
	 * @return  TagnyilvantartasControllerteruletiszervezeteks
	 * @see     JController
	 */
