...
class TagnyilvantartasModelKapcsolatok  extends JModelItem { 

	
	
	protected $context = 'com_tagnyilvantartas.kapcsolatok';   
	/**
	...
	public function populateState()
	{
		...
		$id	= JFactory::getApplication()->input->getInt('kapcs_id', null);
		$this->setState('kapcsolatok.kapcs_id', $id);
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Kapcsolatok', 'Table');
