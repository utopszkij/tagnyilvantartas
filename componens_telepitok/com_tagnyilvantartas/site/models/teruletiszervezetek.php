...
class TagnyilvantartasModelTeruletiszervezetek  extends JModelItem { 

	
	
	protected $context = 'com_tagnyilvantartas.teruletiszervezetek';   
	/**
	...
	public function populateState()
	{
		...
		$id	= JFactory::getApplication()->input->getInt('terszerv_id', null);
		$this->setState('teruletiszervezetek.terszerv_id', $id);
	...
	public function &getItem($id = null)
	{
		if ($this->_item === null) {
			...
			$table = JTable::getInstance('Teruletiszervezetek', 'Table');
