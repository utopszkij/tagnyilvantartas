...
class TagnyilvantartasModelCimkek  extends JModelItem { 

	
	
	protected $context = 'com_tagnyilvantartas.cimkek';   
	/**
	...
	public function populateState()
	{
		...
		$id	= JFactory::getApplication()->input->getInt('cimke_id', null);
		$this->setState('cimkek.cimke_id', $id);
